...
> * Use the prediction endpoint from a Shiny app

If you don’t have an Azure subscription, create a free account before you begin. Try the [free or paid version of Azure Machine Learning](https://aka.ms/AMLFree) today.

## Prerequisites

Follow the steps in [Tutorial: Get started with Azure Machine Learning and its R SDK](https://docs.microsoft.com/azure/machine-learning/service/tutorial-1st-experiment-r-set-up) to get started using RStudio on a cloud-based compute instance in your Azure subscription.  

Or install on your own server. To use the Azure ML R SDK, you need to have Conda installed along with Python 3.5. Follow the [installation instructions](https://azure.github.io/azureml-sdk-for-r/articles/installation.html).
...
@@MINNA - are there setup instructions in GitHub that create a workspace and write a config file?  That's where we should point to if they want to install on their own...I don't think the instrucions above do that?
...
An Azure Machine Learning workspace is a foundational resource in the cloud that you use to experiment, train, and deploy machine learning models. It ties your Azure subscription and resource group to an easily consumed object in the service. Information about your workspace is captured in a "config file". 

In RStudio on your compute instance, the file is already in the root directory and you can skip this next step. If you are using your own environment, create it as follows. You will need to supply your Azure Subscription ID and your selected workspace name and resource group name below. (Note: you only need to do this once).

```{r create config file}
